...
pub async fn uzfs_env_init() {
    ...
    if *guard == 0 {
        ...
        AsyncCoroutine::new(libuzfs_init_c, 0, true).await;
    }
...
pub async fn uzfs_env_fini() {
    ...
    if *guard == 1 {
        AsyncCoroutine::new(libuzfs_fini_c, 0, true).await;
    }
    *guard -= 1;
}
...
impl Dataset {
    ...
    pub async fn init(
        ...
        AsyncCoroutine::new(libuzfs_dataset_init_c, arg_usize, true).await;
    ...
    pub async fn open_snapshot(dsname: &str, snapname: &str) -> Result<Self> {
        ...
        AsyncCoroutine::new(libuzfs_dataset_open_c, arg_usize, true).await;
    ...
    pub async fn create_snapshot(dsname: &str, snapname: &str) -> Result<()> {
        ...
        AsyncCoroutine::new(libuzfs_dataset_snapshot_create_c, arg_usize, true).await;
    ...
    pub async fn destroy_snapshot(dsname: &str, snapname: &str) -> Result<()> {
        ...
        AsyncCoroutine::new(libuzfs_dataset_snapshot_destroy_c, arg_usize, true).await;
    ...
    pub async fn rollback(&mut self, snapname: &str) -> Result<()> {
        ...
        AsyncCoroutine::new(libuzfs_dataset_snapshot_rollback_c, arg_usize, true).await;
    ...
    pub async fn expand(&self) -> Result<()> {
        ...
        AsyncCoroutine::new(libuzfs_dataset_expand_c, arg_usize, true).await;
    ...
    pub async fn get_inode_handle(
        ...
        let arg_usize = &mut arg as *mut _ as usize;
        AsyncCoroutine::new(libuzfs_inode_handle_get_c, arg_usize, true).await;
    ...
    pub async fn release_inode_handle(&self, ino_hdl: &mut InodeHandle) {
        AsyncCoroutine::new(libuzfs_inode_handle_rele_c, ino_hdl.ihp as usize, true).await;
    ...
    pub async fn zap_list(&self, zap_obj: u64) -> Result<Vec<(String, Vec<u8>)>> {
        ...
        AsyncCoroutine::new(libuzfs_zap_list_c, arg_usize, true).await;
    ...
    pub async fn zap_add<P: CStrArgument>(&self, obj: u64, name: P, value: &[u8]) -> Result<u64> {
        ...
        AsyncCoroutine::new(libuzfs_zap_update_c, arg_usize, true).await;
    ...
    pub async fn zap_remove<P: CStrArgument>(&self, obj: u64, name: P) -> Result<u64> {
        ...
        AsyncCoroutine::new(libuzfs_zap_remove_c, arg_usize, true).await;
    ...
    pub async fn create_objects(&self, num_objs: usize) -> Result<(Vec<u64>, u64)> {
        ...
        AsyncCoroutine::new(libuzfs_objects_create_c, arg_usize, true).await;
    ...
    pub async fn delete_object(&self, ino_hdl: &mut InodeHandle) -> Result<()> {
        ...
        AsyncCoroutine::new(libuzfs_delete_object_c, arg_usize, true).await;
    ...
    pub async fn wait_log_commit(&self) {
        ...
        AsyncCoroutine::new(libuzfs_wait_log_commit_c, arg_usize, true).await;
    }
    ...
    pub async fn get_object_attr(&self, ino_hdl: &InodeHandle) -> Result<uzfs_object_attr_t> {
        ...
        AsyncCoroutine::new(libuzfs_get_object_attr_c, arg_usize, true).await;
    ...
    pub async fn list_object(&self) -> Result<u64> {
        ...
        AsyncCoroutine::new(libuzfs_list_object_c, arg_usize, true).await;
    ...
    pub async fn stat_object(&self, obj: u64) -> Result<dmu_object_info_t> {
        ...
        AsyncCoroutine::new(libuzfs_stat_object_c, arg_usize, true).await;
    ...
    pub async fn read_object(
        ...
        AsyncCoroutine::new(libuzfs_read_object_c, arg_usize, true).await;
    ...
    pub async fn write_object(
        ...
        AsyncCoroutine::new(libuzfs_write_object_c, arg_usize, true).await;
    ...
    pub async fn sync_object(&self, ino_hdl: &InodeHandle) {
        ...
        AsyncCoroutine::new(libuzfs_sync_object_c, ino_hdl.ihp as usize, true).await;
    }
    ...
    pub async fn truncate_object(
        ...
        AsyncCoroutine::new(libuzfs_truncate_object_c, arg_usize, true).await;
    ...
    pub async fn space(&self) -> (u64, u64, u64, u64) {
        ...
        AsyncCoroutine::new(libuzfs_dataset_space_c, arg_usize, true).await;
    ...
    pub async fn object_has_hole_in_range(
        ...
        AsyncCoroutine::new(libuzfs_object_next_hole_c, arg_usize, true).await;
    ...
    pub async fn create_inode(&self, inode_type: InodeType) -> Result<InodeHandle> {
        ...
        AsyncCoroutine::new(libuzfs_create_inode_c, arg_usize, true).await;
    ...
    pub async fn claim_inode(&self, ino: u64, gen: u64, inode_type: InodeType) -> Result<()> {
        ...
        AsyncCoroutine::new(libuzfs_claim_inode_c, arg_usize, true).await;
    ...
    pub async fn delete_inode(
        ...
        AsyncCoroutine::new(libuzfs_delete_inode_c, arg_usize, true).await;
    ...
    pub async fn get_attr(&self, ino_hdl: &InodeHandle) -> Result<InodeAttr> {
        ...
        AsyncCoroutine::new(libuzfs_inode_getattr_c, arg_usize, true).await;
    ...
    pub async fn set_attr(&self, ino_hdl: &mut InodeHandle, reserved: &[u8]) -> Result<u64> {
        ...
        AsyncCoroutine::new(libuzfs_set_attr_c, arg_usize, true).await;
    ...
    pub async fn get_kvattr<P: CStrArgument>(
        ...
        AsyncCoroutine::new(libuzfs_inode_get_kvattr_c, arg_usize, true).await;
    ...
    pub async fn set_kvattr<P: CStrArgument>(
        ...
        AsyncCoroutine::new(libuzfs_set_kvattr_c, arg_usize, true).await;
    ...
    pub async fn remove_kvattr<P: CStrArgument>(
        ...
        AsyncCoroutine::new(libuzfs_remove_kvattr_c, arg_usize, true).await;
    ...
    pub async fn list_kvattrs(&self, ino_hdl: &InodeHandle) -> Result<Vec<String>> {
        ...
        AsyncCoroutine::new(libuzfs_list_kvattrs_c, arg_usize, true).await;
    ...
    pub async fn create_dentry<P: CStrArgument>(
        ...
        AsyncCoroutine::new(libuzfs_create_dentry_c, arg_usize, true).await;
    ...
    pub async fn delete_dentry<P: CStrArgument>(
        ...
        AsyncCoroutine::new(libuzfs_delete_entry_c, arg_usize, true).await;
    ...
    pub async fn lookup_dentry<P: CStrArgument>(
        ...
        AsyncCoroutine::new(libuzfs_lookup_dentry_c, arg_usize, true).await;
    ...
    pub async fn iterate_dentry(
        ...
        AsyncCoroutine::new(libuzfs_iterate_dentry_c, arg_usize, true).await;
    ...
    pub async fn set_object_mtime(
        ...
        AsyncCoroutine::new(libuzfs_object_set_mtime, arg_usize, true).await;
    ...
    pub async fn close(&self) -> Result<()> {
        ...
        AsyncCoroutine::new(libuzfs_dataset_fini_c, arg_usize, true).await;
