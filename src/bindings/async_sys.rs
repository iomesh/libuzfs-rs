...
pub struct ZPoolCloseArg {
    pub zhp: *mut libuzfs_zpool_handle_t,

    pub res: i32,
}

unsafe impl Send for ZPoolCloseArg {}
unsafe impl Sync for ZPoolCloseArg {}

pub unsafe extern "C" fn libuzfs_zpool_close_c(args: *mut c_void) {
    let args = &mut *(args as *mut ZPoolCloseArg);
    args.res = libuzfs_zpool_close(args.zhp);
}
